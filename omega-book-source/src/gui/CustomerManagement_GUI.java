...
public class CustomerManagement_GUI extends javax.swing.JPanel{
    ...
    private CustomerManagement_BUSImpl customer_BUS;
    ...
    public CustomerManagement_GUI(){
        ...
        alterTable();
        try {
			customer_BUS = new CustomerManagement_BUSImpl();
...
//		// Products
//		tblModel_customer = new DefaultTableModel(
//				new String[] { "Mã", "Tên khách hàng", "Ngày sinh", "Giới tính", "Hạng" }, 0);
//	}
//
//	public void reloadForm() {
//		txt_customerID.setText("");
...
//		// Tạo header row
//		Row headerRow = sheet.createRow(2);
//		String[] columns = { "Mã khách hàng", "Tên", "Điểm tích lũy", "Gới tính", "Ngày sinh",
//				"Số điện thoại", "Hạng", "Địa chỉ" };
//
//		for (int i = 0; i < columns.length; i++) {
//			Cell cell = headerRow.createCell(i);
//			cell.setCellValue(columns[i]);
...
//						javax.swing.BorderFactory.createTitledBorder(null, "Thông tin khách hàng",
...
//        if (row != -1)
		try {
			...
			if (row != -1) {
				...
				Notifications.getInstance().show(Notifications.Type.ERROR,
						"Chưa chọn khách hàng muốn cập nhật thông tin!");
				return;
			}
	...
	private void btn_createActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_createActionPerformed
		try {
			// TODO add your handling code here:
			boolean isCompleted = customer_BUS.createCustomer(txt_name.getText(), date_dateOfBirth.getDate(),
					txt_phoneNumber.getText(), txt_address.getText(), rad_men.isSelected());
			if (!isCompleted) {
