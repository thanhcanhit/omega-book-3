...
/*		context.bind("rmi://localhost:7878/BillManagement_BUS", billBus);
		...
		context.bind("rmi://localhost:7878/CreatePurchaseOrder_BUS", createPurchaseOrderBus);
		...
		context.bind("rmi://localhost:7878/PurchaseOrderManagement_BUS", purchaseOrderBus);
		context.bind("rmi://localhost:7878/ReturnOrderManagement_BUS", returnOrderBus);
		context.bind("rmi://localhost:7878/Sales_BUS", salesBus);
		context.bind("rmi://localhost:7878/ShiftsManagement_BUS", shiftBus);
		context.bind("rmi://localhost:7878/StatementAccounting_BUS", statementAccountingBus);
		context.bind("rmi://localhost:7878/StatementCashCount_BUS", statementCashCountBus);
		context.bind("rmi://localhost:7878/StatisticCustomer_BUS", statisticCustomerBus);
		...
		context.bind("rmi://localhost:7878/ViewAccoutingVoucherList_BUS", viewAccountingVoucherListBus);
		context.bind("rmi://localhost:7878/ViewCashCountSheetList_BUS", viewCashCountSheetListBus);
*/			
