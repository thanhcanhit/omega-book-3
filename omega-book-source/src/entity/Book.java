...
//    Không truyền price, dùng khi tạo đối tượng mới
	public Book(String author, String publisher, Integer publishYear, String description, Integer pageQuantity,
			Boolean isHardCover, String language, String translator, BookType bookOrigin, BookCategory bookCategory,
			String productID, String name, Double costPrice, byte[] image, Double VAT, Integer inventory, Type type)
			throws Exception {
...
//    Truyền tất cả, dùng khi đọc đối tượng từ db
	public Book(String author, String publisher, Integer publishYear, String description, Integer pageQuantity,
			Boolean isHardCover, String language, String translator, BookType bookOrigin, BookCategory bookCategory,
			String productID, String name, Double costPrice, Double price, byte[] image, Double VAT, Integer inventory,
...
//      Cho phép rỗng
	...
	public String toString() {
		return "Book{" + "author=" + author + ", publisher=" + publisher + ", publishYear=" + publishYear
				+ ", description=" + description + ", quantity=" + pageQuantity + ", isHardCover=" + isHardCover
				+ ", language=" + language + ", translator=" + translator + '}';
	}
