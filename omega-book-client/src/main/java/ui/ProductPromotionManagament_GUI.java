...
public class ProductPromotionManagament_GUI extends javax.swing.JPanel {
	...
	private PromotionManagement_BUS bus;
	...
	private void init() {
		...
		tblModel_inforProductPromotion = new DefaultTableModel(
				new String[] { "Mã khuyến mãi", "Loại", "Giảm giá", "Trạng thái" }, 0);
	...
	private PromotionForProduct getNewValue() throws Exception {
		...
		PromotionForProduct promotion = new PromotionForProduct(promotionID, startedDate, endedDate,
				DiscountType.fromInt(type), discount, cart);
		return promotion;
	}
	...
	private void addItemToCart(Product product) {
		if (product == null) {
			Notifications.getInstance().show(Notifications.Type.INFO,
					"Không tìm thấy sản phẩm có mã " + product.getProductID());
		} else {
			try {
				// Thêm vào khuyến mãi
				...
				Notifications.getInstance().show(Notifications.Type.ERROR,
						"Có lỗi xảy ra khi thêm sản phẩm " + product.getProductID());
			}
		}
	}
	...
	private void initComponents() {
		...
		pnl_txtSearchProduct
				.setLayout(new javax.swing.BoxLayout(pnl_txtSearchProduct, javax.swing.BoxLayout.LINE_AXIS));
		...
		cmb_statusPromo.setModel(
				new javax.swing.DefaultComboBoxModel<>(new String[] { "Trạng thái", "Đang diễn ra", "Đã kết thúc" }));
		...
		pnl_promotionInfor
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Danh sách khuyến mãi",
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14),
								new java.awt.Color(71, 118, 185)),
						javax.swing.BorderFactory.createEmptyBorder(3, 3, 3, 3))); // NOI18N
		...
		tbl_inforProductPromo
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null, null, null, null }, { null, null, null, null },
								{ null, null, null, null }, { null, null, null, null } },
						new String[] { "Mã KM", "Loại KM", "Giảm giá", "Trạng thái" }) {
					@SuppressWarnings("rawtypes")
		...
		pnl_inforPromo
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Thông tin khuyến mãi",
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14),
								new java.awt.Color(71, 118, 185)),
	...
	private void btn_removePromoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_removePromoActionPerformed
		...
		if (pm.getStartedDate().after(java.sql.Date.valueOf(LocalDate.now()))) {
			if (JOptionPane.showConfirmDialog(null,
					"Bạn thật sự muốn gỡ khuyến mãi " + promotionID + " không? Vẫn chưa đến hạn diễn ra khuyến mãi!",
					"Gỡ khuyến mãi?", JOptionPane.YES_NO_OPTION, JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
				try {
					// Xoá
			...
			if (JOptionPane.showConfirmDialog(null, "Bạn thật sự muốn gỡ khuyến mãi " + promotionID + " không?",
					"Gỡ khuyến mãi?", JOptionPane.YES_NO_OPTION, JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
				try {
					// Xoá
