...
public class ReturnOrderManagemant_GUI extends javax.swing.JPanel {
	...
	private void init() {
		...
		// model
		tblModel_returnOrder = new DefaultTableModel(
				new String[] { "Mã hoá đơn đổi trả", "Mã hoá đơn", "Ngày đổi trả", "Trạng thái" }, 0);
		...
		// combobox
		cmbModel_statusReturnOrder = new DefaultComboBoxModel(
				new String[] { "Trạng thái", "Đang chờ", "Đã xác nhận", "Đã từ chối" });
	...
	private void renderReturnOrderTables(ArrayList<ReturnOrder> allReturnOrder) {
		...
		for (ReturnOrder returnOrder : allReturnOrder) {
			if (returnOrder.getStatus().getValue() == 0)
				...
				status = "Đã từ chối";
			String[] newRow = { returnOrder.getReturnOrderID(), returnOrder.getOrder().getOrderID(),
					returnOrder.getOrderDate().toString(), status };
	...
	private void updateReturnOrder() throws RemoteException {
		...
		if (!rdb_admit.isSelected() & !rdb_deny.isSelected()) {
			Notifications.getInstance().show(Notifications.Type.WARNING,
					"Vui lòng chọn trạng thái xác nhận đơn đổi trả");
			return;
		}
...
//        }
	...
	private void initComponents() {
		...
		pnl_searchRerturnOrder
				.setLayout(new javax.swing.BoxLayout(pnl_searchRerturnOrder, javax.swing.BoxLayout.X_AXIS));
		...
		cmb_statusReturnOrder.setModel(new javax.swing.DefaultComboBoxModel<>(
				new String[] { "Trạng thái", "Đang chờ", "Đã xác nhận", "Đã từ chối" }));
		pnl_filterReturnOrder.add(cmb_statusReturnOrder);

		cmb_typeReturnOrder
				.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Loại đơn", "Đổi hàng", "Trả hàng" }));
		...
		tbl_inforReturnOrder
				.setModel(new javax.swing.table.DefaultTableModel(
						new Object[][] { { null, null, null, null }, { null, null, null, null },
								{ null, null, null, null }, { null, null, null, null } },
						new String[] { "Mã HĐĐT", "Mã HĐ", "Ngày đổi", "Trạng thái" }) {
					@SuppressWarnings("rawtypes")
		...
		pnl_eastReturnOrder
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Chi tiết đơn đổi trả",
		...
		pnl_statusReturnOrder
				.setLayout(new javax.swing.BoxLayout(pnl_statusReturnOrder, javax.swing.BoxLayout.LINE_AXIS));
