...
public class StatisticCustomer_GUI extends javax.swing.JPanel {
	...
	private StatisticCustomer_BUS statisticCustomer_BUS;
	private int[] data;
	private int numCus;
	...
	public StatisticCustomer_GUI() throws RemoteException {
		try {
			statisticCustomer_BUS = (StatisticCustomer_BUS) Naming.lookup(RMIService.statisticCustomerBus);
		} catch (MalformedURLException | RemoteException | NotBoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		data = statisticCustomer_BUS.filterCustomers();
		numCus = statisticCustomer_BUS.getNumberCus();
		initComponents();
		initDataInfo();
		initPieChart();
	}
	...
	public void initDataInfo() throws RemoteException {
		...
		txt_female.setText(
				Integer.toString(statisticCustomer_BUS.sumCustomer() - statisticCustomer_BUS.countMaleCustomers()));
	...
	public void initPieChart() {
		...
		polarAreaChart
				.addItem(new ModelPolarAreaChart(new Color(129, 143, 180), "Nam dưới 18 tuổi", getRat(data[3])));

		polarAreaChart
				.addItem(new ModelPolarAreaChart(new Color(230, 105, 62), "Nam từ 18 đến 40 tuổi", getRat(data[4])));
		...
		polarAreaChart.addItem(
				new ModelPolarAreaChart(new Color(255, 223, 223), "Nữ từ 18 đến 40 tuổi", getRat(data[1])));
	...
	private void initComponents() {
		...
		pnl_chart
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Thống kê theo nhóm khách hàng",
		...
		pnl_groupOfMale
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Khách hàng nam",
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14),
								new java.awt.Color(71, 118, 185)),
		...
		pnl_groupOfFemale
				.setBorder(javax.swing.BorderFactory.createCompoundBorder(
						javax.swing.BorderFactory.createTitledBorder(null, "Khách hàng nữ",
								javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
								javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14),
								new java.awt.Color(71, 118, 185)),
						javax.swing.BorderFactory.createEmptyBorder(1, 5, 1, 1))); // NOI18N
