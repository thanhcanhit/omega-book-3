...
public final class StatisticProduct_GUI extends javax.swing.JPanel {
     ...
     */
    public StatisticProduct_GUI() throws RemoteException {
        initComponents();
        init();
        alterTable();
    ...
    private void renderProductTable(ArrayList<Product> productList, String date) throws RemoteException {
    ...
    public void getChart(String date) throws RemoteException {
        chart.clear();
    ...
    public void renderInfoProduct(Product p, String date) throws RemoteException {
