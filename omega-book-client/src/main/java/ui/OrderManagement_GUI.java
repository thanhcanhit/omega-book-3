...
public final class OrderManagement_GUI extends javax.swing.JPanel {
	...
	private BillManagement_BUS bus;
	...
	public void init() throws RemoteException {
		try {
			bus = (BillManagement_BUS) Naming.lookup(RMIService.billBus);
		} catch (MalformedURLException | RemoteException | NotBoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}

		tblModel_order = new DefaultTableModel(
				new String[] { "Mã hoá đơn", "Nhân viên", "Khách hàng", "Ngày mua", "Thành tiền" }, 0);
		...
		tblModel_orderDetail = new DefaultTableModel(
				new String[] { "Mã sản phẩm", "Tên sản phẩm", "Số lượng", "Đơn giá", "Tổng tiền" }, 0);
...
//      Toggle button
	...
	private void renderOrdersTable(ArrayList<Bill> orderList) {
		...
		for (Bill order : orderList) {
			Object[] newRow = new Object[] { order.getOrderID(), order.getEmployee().getName(),
					order.getCustomer().getCustomerID(), order.getOrderAt(), FormatNumber.toVND(order.getSubTotal()) };
	...
	private void renderOrderDetailTable(ArrayList<OrderDetail> list) throws RemoteException {
		...
		for (OrderDetail orderDetail : list) {
			ProductManagement_BUS productBUS;
			try {
				productBUS = (ProductManagement_BUS) Naming.lookup(RMIService.productBus);

				Object[] newRow = new Object[] { orderDetail.getProduct().getProductID(),
						productBUS.getProduct(orderDetail.getProduct().getProductID()).getName(),
						orderDetail.getQuantity(), orderDetail.getPrice(),
						FormatNumber.toVND(orderDetail.getLineTotal()) };
	...
	public static void createExcel(ArrayList<Bill> list, String filePath) {
		...
		String[] columns = { "Mã hoá đơn", " Mã nhân viên", "Tên khách hàng", " Ngày mua hàng",
				"Số điện thoại khách hàng", "Tổng tiền" };
	...
	private void initComponents() {
		...
		pnl_orderStatusFilter
				.setLayout(new javax.swing.BoxLayout(pnl_orderStatusFilter, javax.swing.BoxLayout.LINE_AXIS));
		...
		cmb_orderPriceFilter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Dưới 100.000VNĐ",
				"Trên 100.000VNĐ & Dưới 500.000VNĐ", "Trên 500.000VNĐ & Dưới 1.000.000VNĐ", "Trên 1.000.000VNĐ" }));
		...
		pnl_center.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách hoá đơn: ",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(71, 118, 185))); // NOI18N
		...
		pnl_orderDetail.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Chi tiết hoá đơn:",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(71, 118, 185))); // NOI18N
		...
		pnl_info.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin:",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(71, 118, 185))); // NOI18N
	...
	private void btn_wfileActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btn_wfileActionPerformed
		...
		if (validateFields()) {
			...
			if (orderID.trim().length() <= 0 && customerID.trim().length() <= 0 && phone.trim().length() <= 0) {
				if (JOptionPane.showConfirmDialog(this, "Bạn có muốn xuất toàn bộ hoá đơn ?", "Xuất file excel",
