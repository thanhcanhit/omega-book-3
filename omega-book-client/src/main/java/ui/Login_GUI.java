...
public class Login_GUI extends javax.swing.JPanel {
	...
	private Login_BUS log_BUS;// = new Login_BUSImpl();
	...
	public Login_GUI() {
		try {
			try {
				log_BUS = (Login_BUS) Naming.lookup(RMIService.loginBus);
	...
	private void initComponents() {
		...
		filler1 = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(0, 150),
		...
		filler2 = new javax.swing.Box.Filler(new java.awt.Dimension(0, 0), new java.awt.Dimension(0, 90),
				new java.awt.Dimension(32767, 100));
		...
		pwr_password.putClientProperty(FlatClientProperties.STYLE, "" + "showRevealButton:true;" + "showCapsLock:true");
		...
		pnl_changePasswordForm
				.setLayout(new javax.swing.BoxLayout(pnl_changePasswordForm, javax.swing.BoxLayout.Y_AXIS));
		...
		// javax.swing.ImageIcon(getClass().getResource("/imgs/login/OmegaBook-2.png"));
		// Image image = imageIcon.getImage();
		// Image scaledImage = image.getScaledInstance(lbl_img.getWidth(),
		// lbl_img.getHeight(), Image.SCALE_SMOOTH | Image.SCALE_AREA_AVERAGING);
		//
		//// Tạo lại đối tượng ImageIcon với kích thước mới
		// imageIcon = new ImageIcon(scaledImage);
		lbl_img.setIcon(new javax.swing.ImageIcon("resources/imgs/login/OmegaBook-2.png")); // NOI18N
